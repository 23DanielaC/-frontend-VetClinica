      ...
      <div class="relative flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
        <div class="flex-1">
          ...
          <p class="text-slate-600 mt-2 max-w-2xl text-sm sm:text-base leading-relaxed">
            Resumen de VetClinica: <strong class="text-slate-800">{{ resumenSistema.clientes }} clientes</strong>,
            <strong class="text-slate-800">{{ resumenSistema.mascotas }} mascotas</strong> registradas y
            <strong class="text-slate-800">{{ resumenSistema.turnosActivos }} turnos</strong> activos este periodo.
          </p>
        </div>
